...
from attack.normal_gen import NormalisedEnhancedMixedSignal
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("normalised_enhanced_signal.log"),
    ]
)
...
def main():
    ...
    evaluator = HyperparameterEvaluator(
        ...
        write_path="normalised_enhanced_attack_results/",
