...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("mixed_normal_residual_signal.log"),
    ]
)
...
def main():
    ...
    evaluator = HyperparameterEvaluator(
        attack_class=MixedNormalResidualSignalAttack,#MixedResidualSignalAttack,
        pipe=pipe,
        classifiers=classifiers,
        evaluate_image_fn=evaluate,
        write_path="mixed_normal_residual_attack_results/",
