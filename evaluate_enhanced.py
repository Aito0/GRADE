...
from attack.normal_gen import EnhancedMixedSignal
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("enhanced_signal.log"),
    ]
)
...
def main():
    ...
    evaluator = HyperparameterEvaluator(
        attack_class=EnhancedMixedSignal,#MixedResidualSignalAttack,
        pipe=pipe,
        classifiers=classifiers,
        evaluate_image_fn=evaluate,
        write_path="enhanced_attack_results/",
